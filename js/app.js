(() => {
  ...
  window.addEventListener("load", function (e) {
    me(),
      document.querySelector(".fleets__slider") &&
        new de(".fleets__slider", {
          modules: [pe, he, fe],
          observeParents: !0,
          slidesPerView: 1,
          spaceBetween: 30,
          ...
          pagination: {
            ...
            renderBullet: function (e, t) {
              return `\n\t\t\t\t<div class="fleets__dot dot-fleets swiper-pagination-bullet">\n\t\t\t\t\t<div class="dot-fleets__wrapper">\n\t\t\t\t\t\t<div class="dot-fleets__image-ibg"><img src="img/fleets/pag-${
                e + 1
              }.png" alt="">\n\t\t\t\t\t\t</div>\n\t\t\t\t\t\t<h4 class="dot-fleets__title">\n\t\t\t\t\t\t\t${
                ge[e]
              }\n\t\t\t\t\t\t</h4>\n\t\t\t\t\t</div>\n\t\t\t\t</div>\n\t\t  `;
            },
          },
          navigation: {
            nextEl: ".fleets__arrows .fleets__arrow_next",
            prevEl: ".fleets__arrows .fleets__arrow_prev",
          },
          on: {},
        });
  });
  class ve {
    ...
    getScrollWatcherConfig(e) {
      ...
      if (
        (document.querySelector(e.root)
          ...
          : "null" !== e.root && this.scrollWatcherLogging(""),
    ...
    scrollWatcherOff(e, t) {
      t.unobserve(e), this.scrollWatcherLogging("");
    }
  ...
  setTimeout(() => {
    ...
    window.addEventListener("load", (e) => {
      const s = document.querySelector(".actions-header__languages");
      s &&
        t.any() &&
        ...
        window.addEventListener("click", (e) => {
          e.target.closest(".actions-header__languages") ||
